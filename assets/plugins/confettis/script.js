module.exports = function(zona, quantity, gravity, friction, wind) {
	var utils = {
	...
	//
	generator1 = new particleGenerator(0, 0, W, H, quantity);
	...
	function update() {
		...
		generator1.number = quantity;

		context.fillStyle="white";
		context.clearRect(0, 0, W, H);
		generator1.animate();

		document.getElementById(zona) !== null && requestAnimationFrame(update);
	}
}